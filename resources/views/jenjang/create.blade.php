@extends('layouts.app', ['title' => 'Tambah Jenjang'])
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Form Tambah Data Jenjang</h4>
                <p class="text-muted mb-3">Isi semua kolom yang diperlukan untuk menambahkan data jenjang baru.</p>
